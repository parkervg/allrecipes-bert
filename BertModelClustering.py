...
class BertModelClustering():
    ...
    def __init__(self,
                 ...
                 model_dir=None,  # Pre-trained/fine-tuned model directory
                 model_name=None, # Existing HuggingFace model, e.g. 'bert-base-uncased'
                 config=BertConfig.from_pretrained('bert-base-uncased', output_hidden_states=True),
                 tokenizer=BertTokenizer.from_pretrained('bert-base-uncased'),
                 extraction_function="small",
                 n_top_verbs=5 # Number of verbs to list in output and take into consideration for cluster coherence score
                 ):
